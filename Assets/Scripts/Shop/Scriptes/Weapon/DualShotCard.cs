...
[CreateAssetMenu(fileName = "_weapon", menuName = "Card/Weapon/Dual Shot")]
public class DualShotCard : Card, IWeapon
{
    ...
    {
        is_unlocked_weapon = game_data.dual_shot_unlocked;
    ...
    {
        game_data.dual_shot_unlocked = is_unlocked_weapon;

...
[CreateAssetMenu(fileName = "_weapon", menuName = "Card/Weapon/Tripple Shot")]
public class TrippleShotCard : Card, IWeapon
{
    int total_score;
    string current_path;
    ...
    {
        is_unlocked_weapon = game_data.trippl_shot_unlocked;
    ...
    {
        game_data.trippl_shot_unlocked = is_unlocked_weapon;
